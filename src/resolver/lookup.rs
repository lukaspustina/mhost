...
impl Lookups {
    ...
    lookups_data_accessor!(dnssec, DNSSEC);
    ...
    lookups_record_accessor!(rr_dnssec, RecordType::DNSSEC);
...
impl Lookup {
    ...
    lookup_data_accessor!(dnssec, DNSSEC);
    ...
    lookup_record_accessor!(rr_dnssec, RecordType::DNSSEC);
