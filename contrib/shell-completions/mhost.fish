...
complete -c mhost -n "__fish_use_subcommand" -f -a "service" -d 'Looks up a service using convenient service specification'
...
complete -c mhost -n "__fish_seen_subcommand_from service" -s h -l help -d 'Prints help information'
complete -c mhost -n "__fish_seen_subcommand_from service" -s V -l version -d 'Prints version information'
