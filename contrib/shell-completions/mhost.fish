...
complete -c mhost -n "__fish_use_subcommand" -f -a "download-server-lists" -d 'Downloads known lists of name servers'
...
complete -c mhost -n "__fish_seen_subcommand_from download-server-lists" -s o -l output-file -d 'Sets path to output file'
complete -c mhost -n "__fish_seen_subcommand_from download-server-lists" -s h -l help -d 'Prints help information'
