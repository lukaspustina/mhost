...
complete -c mhost -n "__fish_use_subcommand" -l max-worker-threads -d 'Set the max. number of worker threads overriding derived value'
...
complete -c mhost -n "__fish_use_subcommand" -f -a "server-lists" -d 'Downloads known lists of name servers'
complete -c mhost -n "__fish_seen_subcommand_from check" -s p -l show-partial-results -d 'Shows results after each check step'
complete -c mhost -n "__fish_seen_subcommand_from check" -s i -l show-intermediate-lookups -d 'Shows all lookups made during by all checks'
complete -c mhost -n "__fish_seen_subcommand_from check" -l no-cnames -d 'Does not run cname lints'
complete -c mhost -n "__fish_seen_subcommand_from check" -l no-soa -d 'Does not run SOA check'
...
complete -c mhost -n "__fish_seen_subcommand_from lookup" -s s -l service -d 'Parses ARG as service spec and set record type to SRV'
...
complete -c mhost -n "__fish_seen_subcommand_from server-lists" -s o -l output-file -d 'Sets path to output file'
complete -c mhost -n "__fish_seen_subcommand_from server-lists" -s h -l help -d 'Prints help information'
complete -c mhost -n "__fish_seen_subcommand_from server-lists" -s V -l version -d 'Prints version information'
